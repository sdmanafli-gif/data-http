-- Profiles (admin / store_manager) and auto-create profile on signup
-- Run after enabling Auth in Supabase Dashboard. First admin: create via Dashboard → Authentication → Users → Add user, then set role in SQL: UPDATE public.profiles SET role = 'admin' WHERE email = 'that@email.com';
